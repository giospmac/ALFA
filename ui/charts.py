...
PALETTE_SECONDARY = "#1d3a9c"
PALETTE_NEGATIVE = "#1d3a9c"
PALETTE_WARNING = "#8aa8fa"
...
def render_charts_page() -> None:
    ...
    if contribution_df.empty:
        ...
        fig.update_yaxes(title_text="", showticklabels=False, showgrid=True, gridcolor="#e2e0d8", zeroline=True)
        st.plotly_chart(fig, use_container_width=True, theme=None, config={'displayModeBar': False})
