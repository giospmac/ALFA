...
def render_home_page() -> None:
    ...
    if normalized_df.empty:
        ...
        if "Portfolio" in normalized_df.columns:
            ...
            fig_portfolio.update_xaxes(showgrid=False, zeroline=False, showline=True, linecolor="#e2e0d8", linewidth=1)
            fig_portfolio.update_yaxes(showgrid=True, gridcolor="#e2e0d8", gridwidth=1, zeroline=False, showline=False, title_text="")
            st.plotly_chart(fig_portfolio, use_container_width=True, theme=None, config={"displayModeBar": False})
        ...
        if asset_columns:
            ...
            _ASSET_COLORS = [
                "#4979f6", "#1d3a9c", "#101a3a", "#2563eb", "#1d4ed8",
                "#3b82f6", "#8aa8fa", "#8aa8fa", "#1e40af", "#1d3a9c",
            ...
            fig_assets.update_xaxes(showgrid=False, zeroline=False, showline=True, linecolor="#e2e0d8", linewidth=1)
            fig_assets.update_yaxes(showgrid=True, gridcolor="#e2e0d8", gridwidth=1, zeroline=False, showline=False, title_text="")
            st.plotly_chart(fig_assets, use_container_width=True, theme=None, config={"displayModeBar": False})
