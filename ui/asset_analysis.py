...
def _render_asset_analysis_styles() -> None:
    st.markdown(
        ...
        :root {
            ...
            --asset-radius-lg: 18px;
            --asset-radius-md: 14px;
        ...
        section.main div[data-testid="stButton"] > button[kind="primary"] {
            ...
            background: #2f5adf !important;
            background-color: #2f5adf !important;
...
def render_asset_analysis_page(default_ticker: str = "") -> None:
    ...
    shell = st.container(key="asset_search_shell")
    with shell:
